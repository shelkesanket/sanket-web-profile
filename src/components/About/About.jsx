      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            >
              I'm a Frontend Developer with 6+ years of experience delivering
              enterprise-grade React applications. I specialize in
              micro-frontend architecture, TypeScript systems, and
            ...
            >
              Currently at Barclays, I've helped teams migrate massive
              monolithic codebases to scalable micro-frontend platforms, built
              shared component libraries, and brought test coverage to
              production-grade standards. I care deeply about the developer
              experience and believe that clean architecture enables teams to
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {values.map(({ icon, label, desc }, i) => (
              ...
              >
                ...
                <h3 className="font-display font-700 text-base mb-1.5">
                  {label}
                </h3>
